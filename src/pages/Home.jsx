...
function IconLink({ to, label, children }) {
  return (
    <Link
      to={to}
      aria-label={label}
      className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/14 bg-white/[0.06] text-lg text-[color:var(--text)] transition hover:-translate-y-0.5 hover:border-white/24 hover:bg-white/[0.1] focus-visible:bg-white/[0.1]"
    >
      {children}
    </Link>
  );
...
export default function Home() {
  return (
    <>
      ...
      <section className="home-editorial-scene relative min-h-[100svh] overflow-hidden bg-[#030205] text-[color:var(--text)]">
        <div className="home-editorial-scene__stars" aria-hidden="true" />
        <div className="home-editorial-scene__space" aria-hidden="true" />
        <div className="home-editorial-scene__ground" aria-hidden="true" />
        <div className="home-editorial-scene__plant" aria-hidden="true" />
        <div className="home-editorial-scene__vignette" aria-hidden="true" />

        <div className="mx-auto flex min-h-[100svh] w-full max-w-[1680px] items-center px-4 py-4 sm:px-6 lg:px-8 lg:py-8">
          <div className="home-editorial-shell grid w-full gap-4 lg:grid-cols-[0.94fr_1.06fr] lg:gap-5">
            <aside className="home-left-glass relative overflow-hidden rounded-[34px] border border-white/10 bg-[rgba(9,10,14,0.24)] p-6 text-[color:var(--text)] shadow-[0_40px_80px_rgba(0,0,0,0.3)] backdrop-blur-md sm:p-8 lg:p-10">
              ...
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_16%_14%,rgba(157,255,208,0.08),transparent_18%),radial-gradient(circle_at_82%_18%,rgba(132,123,255,0.09),transparent_24%),radial-gradient(circle_at_60%_102%,rgba(91,183,255,0.07),transparent_24%)]" />
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-3">
                    {featurePanels.map((panel, index) => (
                      <div
                        key={panel.title}
                        className="home-feature-panel rounded-[24px] border border-white/10 bg-white/[0.04] p-4 backdrop-blur-sm"
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <IconLink to="/products" label="Open products">
                      <span aria-hidden="true">↗</span>
                    </IconLink>
                    <IconLink to="/review" label="Open review">
                      <span aria-hidden="true">⌁</span>
                    </IconLink>
                  </div>
                </div>
            ...
            <article className="home-mvp-card relative overflow-hidden rounded-[34px] border border-white/18 bg-[linear-gradient(180deg,rgba(255,255,255,0.82),rgba(248,245,238,0.94))] p-4 shadow-[0_35px_90px_rgba(0,0,0,0.26)] sm:p-5 lg:p-6">
